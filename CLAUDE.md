...
- Run `npm run lint` (ESLint flat config in `eslint.config.js`, using `@eslint/js`, `typescript-eslint` and `eslint-plugin-react-hooks`) before considering frontend changes done.
